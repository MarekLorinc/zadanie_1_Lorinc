...
<body>
  ...
  <!-- ***** Header Area Start ***** -->
  <?php
  $file_path_header = "paths/header.php";
  if(!include($file_path_header)) {
    echo"Failed to include $file_path_header";
  }
  ?>
  <!-- ***** Header Area End ***** -->
  ...
  <?php
  $file_path_footer = "paths/footer.php";
  if(!include($file_path_footer)) {
      echo"Failed to include $file_path_footer";
  }
  ?>
  <!-- Scripts -->
